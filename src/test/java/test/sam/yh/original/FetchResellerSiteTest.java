...
public class FetchResellerSiteTest {
    private static final Logger logger = LoggerFactory.getLogger(FetchResellerSiteTest.class);
    ...
    @Test
    public void testFetchResellerSite() {

        FetchResellerReq reqObj = new FetchResellerReq();
        ...
        String url = UriComponentsBuilder.fromHttpUrl("http://localhost:8080/reseller/site.json").build().toUriString();
